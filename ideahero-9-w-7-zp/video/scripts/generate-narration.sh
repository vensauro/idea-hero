...
TEXT="${VIDEO_DIR}/narration/pt-BR.txt"
OUTPUT_DIR="${APP_DIR}/public/video"
RAW_OUTPUT="${OUTPUT_DIR}/narration-raw.wav"
FINAL_OUTPUT="${OUTPUT_DIR}/narration.wav"
